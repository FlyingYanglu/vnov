...
class Refiner(Role):
    ...
    def refine_novel(self, novel:Novel, start_chapter=1, end_chapter=None, save_dir=None, main_character = "史金", **kwargs):
        self.send_greeting_message()
        if save_dir is None:
        ...
        for chapter_num in tqdm.tqdm(range(start_chapter, end_chapter+1)):
            ...
            chapter_chunks = Novel.split_chapter(chapter_content, self.bot_token_max_length-len(REFINE_CHAPTERS)-len(last_context))
